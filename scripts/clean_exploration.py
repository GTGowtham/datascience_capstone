...
summary_file = os.path.join(output_dir, "01_exploration_summary.txt")
...
stats_file = os.path.join(output_dir, "02_statistical_summary.csv")
...
missing_file = os.path.join(output_dir, "03_missing_values_report.csv")
...
outlier_file = os.path.join(output_dir, "04_outliers_report.csv")
...
plt.tight_layout()
age_plot = os.path.join(output_dir, "05_age_distribution.png")
...
plt.tight_layout()
income_plot = os.path.join(output_dir, "06_income_distribution.png")
...
plt.grid(True, alpha=0.3, axis='y')
plt.tight_layout()
hours_plot = os.path.join(output_dir, "07_hours_by_income.png")
...
plt.grid(True, alpha=0.3, axis='y')
plt.tight_layout()
edu_plot = os.path.join(output_dir, "08_education_distribution.png")
...
plt.tight_layout()
corr_plot = os.path.join(output_dir, "09_correlation_heatmap.png")
...
print("\nGenerated Files:")
print("  1. 01_exploration_summary.txt      - Dataset overview and first rows")
print("  2. 02_statistical_summary.csv      - Descriptive statistics")
print("  3. 03_missing_values_report.csv    - Missing values analysis")
print("  4. 04_outliers_report.csv          - Outlier detection results")
print("  5. 05_age_distribution.png         - Age histogram")
print("  6. 06_income_distribution.png      - Income bar chart")
print("  7. 07_hours_by_income.png          - Working hours box plot")
print("  8. 08_education_distribution.png   - Education bar chart")
print("  9. 09_correlation_heatmap.png      - Feature correlations")
print("\n" + "="*80 + "\n")
