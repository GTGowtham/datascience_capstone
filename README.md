...
│
├── scripts/
│   ├── 02_clean_exploration.py   # Main exploration script (recommended)
│   ├── 01_data_exploration.py    # Detailed exploration with console output
│   └── data_exploration.py       # Original version
│
├── output/                  # Generated analysis results
│   ├── 01_exploration_summary.txt
│   ├── 02_statistical_summary.csv
│   ├── 03_missing_values_report.csv
│   ├── 04_outliers_report.csv
│   ├── 05_age_distribution.png
│   ├── 06_income_distribution.png
│   ├── 07_hours_by_income.png
│   ├── 08_education_distribution.png
│   └── 09_correlation_heatmap.png
│
├── knowledge/
│   └── skills_and_process_guide.md  # Detailed learning guide
│
...
2. Open the file `scripts/02_clean_exploration.py`
...
### Clean Exploration Script (02_clean_exploration.py) - Recommended
...
- **Output:** `01_exploration_summary.txt`
...
- **Output:** `02_statistical_summary.csv`
...
- **Output:** `03_missing_values_report.csv`
